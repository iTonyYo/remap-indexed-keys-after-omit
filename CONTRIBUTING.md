...
首先，感谢你考虑为 [`remap-indexed-keys-after-omit`][remap-indexed-keys-after-omit] 做出贡献！正是像您这样的人，使得 [`remap-indexed-keys-after-omit`]/remap-indexed-keys-after-omit] 成为一个更好的工具。:tada::+1:

[remap-indexed-keys-after-omit]: https://github.com/iTonyYo/remap-indexed-keys-after-omit
