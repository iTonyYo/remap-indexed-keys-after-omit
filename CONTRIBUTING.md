...
首先，感谢你考虑为 [`@oopsunome/remap-indexed-keys-after-omit`][@oopsunome/remap-indexed-keys-after-omit] 做出贡献！正是像您这样的人，使得 [`@oopsunome/remap-indexed-keys-after-omit`][@oopsunome/remap-indexed-keys-after-omit] 成为一个非常好的工具。:tada::+1:
